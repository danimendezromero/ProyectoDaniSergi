      ...
      <div class="row perfil" >
        <div class="card #546e7a col l6 m6" style="background-color:#546e7a; -webkit-box-shadow: none; box-shadow: none ">
          <div class="center" style="padding-top:20px;">
            <img class="" id="fotoperfil" src="assets/img/leaguehome.jpg" border="1" alt="Este es el ejemplo de un texto alternativo" width="400px" height="400px">
          </div>
        </div>
        <div class="card col l6 m6" style="background-color:#546e7a; -webkit-box-shadow: none; box-shadow: none ">
            <div class="center" style="padding-top:20px;">
              <img class="" id="fotoperfil" src="assets/img/csgohome.jpg" border="1" alt="Este es el ejemplo de un texto alternativo" width="400px" height="400px">
            </div>
        </div>
