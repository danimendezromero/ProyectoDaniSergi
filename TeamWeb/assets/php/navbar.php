  ...
  <div class="nav-wrapper hide-on-med-and-down">
    ...
    <ul class="hide-on-med-and-down right">
      ...
      <li id="buscador">
        ...
        <li id="iniciar"><a href="Login.php" class="waves-effect waves-dark btn white black-text">Log-in</a></li>
        <li id="registrar"><a href="Register.php" class="waves-effect waves-light btn blue">Register</a></li>
    </ul>
  </div>
</nav>
...
<ul id="slide-out" class="sidenav">
  ...
  <li class="login"><a href="Login.php" class="waves-effect waves-dark btn white black-text">Log-in</a></li>
  <li ><a href="Register.php" class="waves-effect waves-light btn blue">Register</a></li>
</ul>
<!-- ========== End of Navbar ============== -->
